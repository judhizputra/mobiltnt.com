        ...
        <div class="container">
            <h1 class="page-title">Detail Riwayat Rental</h1>
        </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        	...
                        	<input type="submit" class="btn btn-info" value="Proses Pesanan">
                        	<input type="submit" class="btn btn-success" value="Kirim Mobil">
                            <div class="gap"></div>
                        </div>
                    </div>
