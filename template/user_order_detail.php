        ...
        <div class="container">
            <h1 class="page-title">Detail Riwayat Pesanan</h1>
        </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        	...
                        	<input type="submit" class="btn btn-info" value="Proses Pembayaran">
                        	<input type="submit" class="btn btn-danger" value="Kembalikan mobil, tidak sesuai dengan permintaan">
                        	<input type="submit" class="btn btn-success" value="Mobil sesuai permintaan">
                            <div class="gap"></div>
                        </div>
                    </div>
